...
def autocomplete():
    ...
    if request.method == 'GET':  # a query has been submitted
        ...
        if prefix is not None:
            ...
            # Queries are autocompleted against the bbuy_queries index
            # Products will be instant searched against the bbuy_products index
            if type == "queries":
            ...
            search_response = opensearch.search(body=q, index=index_name)
